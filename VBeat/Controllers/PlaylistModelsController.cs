...
namespace VBeat.Controllers
{
    public class PlaylistModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PlaylistId,Public,PlaylistImage")] PlaylistModel playlistModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PlaylistId,Public,PlaylistImage")] PlaylistModel playlistModel)
        {
